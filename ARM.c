...
#define GPIO_A_IDR ((READONLY volatile uint16_t*) GPIO_A_IDR_ADDR)[0]
#define GPIO_A_ODR ((volatile uint16_t*) GPIO_A_ODR_ADDR)[0]

#define GPIO_B_IDR ((READONLY volatile uint16_t*) GPIO_B_IDR_ADDR)[0]
#define GPIO_B_ODR ((volatile uint16_t*) GPIO_B_ODR_ADDR)[0]

#define GPIO_C_IDR ((READONLY volatile uint16_t*) GPIO_C_IDR_ADDR)[0]
